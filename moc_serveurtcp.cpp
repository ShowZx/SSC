...
QT_MOC_LITERAL(1, 11, 14), // "emettreMessage"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17), // "AttenteAceptation"
QT_MOC_LITERAL(4, 45, 9) // "Connexion"

    },
    "ServeurTCP\0emettreMessage\0\0AttenteAceptation\0"
    "Connexion"
};
...
void ServeurTCP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->AttenteAceptation(); break;
        case 2: _t->Connexion(); break;
        default: ;
        }
        ...
        {
            typedef void (ServeurTCP::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServeurTCP::emettreMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ServeurTCP::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ServeurTCP.data,
      qt_meta_data_ServeurTCP,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ServeurTCP::emettreMessage(QByteArray _t1)
{
